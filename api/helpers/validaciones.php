<?php
/*Clase para validaciones del lado del servidor*/
class Validator
{
...
*   Retorno: booleano (true si el valor es correcto o false en caso contrario).
*/
    public function validatePassword($value, $nombres, $apellidos, $alias)
    {
                        ...
                        if(preg_match("#[a-z]+#", $value)) {
                            ...
                            if(preg_match("#[\W]+#", $value)) {
                                ...
                                if (preg_match("#(($nombres)|($apellidos)|($alias)|($nombresupper)|($apellidosupper)|($aliasupper)|($nombreslower)|($apellidoslower)|($aliaslower)|(Admin)|(qwerty)|(123)|(Password))#", $value)){
                                    $this->passwordError = "La clave no debe contener el nombre, apellido, alias, o contraseñas casuales";
                                    return false;
                                } else {
                                    return true;
                                }
                            } else {
                                $this->passwordError = "La clave debe contener al menos 1 caracter especial";
                                return false;
                            }
                        } else {
                            $this->passwordError = "La clave debe contener al menos 1 letra minúscula";
                            return false;
                        }
                    } else {
                        $this->passwordError = "La clave debe contener al menos 1 letra mayúscula";
                        return false;
                    }
                } else {
                    $this->passwordError = "La clave debe contener al menos 1 número";
                    return false;
                }
            } else {
