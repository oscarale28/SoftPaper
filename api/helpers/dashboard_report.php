...
class Report extends FPDF
{
    ...
    */
    public function header()
    {
        ...
        $this->image('../../resources/img/fondo/pr1.png', 0, 0, 250);

        // Se establece el logo.
        $this->image('../../resources/img/logo/ico2.png', 160, 11, 28);
        
        //Añadimos la fuente poppins externa para el título del reporte y lo ubicamos
        $this->addFont('Poppins-Bold','','Poppins-Bold.php');
        $this->setFont('Poppins-Bold','',32);
        $this->SetTextColor(255, 255, 255);
        $this->cell(186, 25, utf8_decode($this->title), 0, 1, 'L');
        ...
        $this->cell(93, 15, utf8_decode('Reporte generado por: '.$_SESSION['alias_usuario']), 0, 1, 'R');
