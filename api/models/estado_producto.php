...
class EstadoProducto extends Validator
{
    ...
    */
    ...
    {
        $sql = 'SELECT uuid_estado_producto, estado_producto, estado_estado_producto FROM estado_producto ORDER BY estado_producto';
        $params = null;
    ...
    {
        $sql = 'SELECT uuid_estado_producto, estado_producto, estado_estado_producto FROM estado_producto WHERE estado_estado_producto = true ORDER BY estado_producto';
        $params = null;
        return Database::getRows($sql, $params);
    }
    ...
    public function changeRow()
    {
        ...
        $sql = 'UPDATE estado_producto SET estado_estado_producto = ? WHERE uuid_estado_producto = ?';
        $params = array($this->estado, $this->id);
        return Database::executeRow($sql, $params);
    }
}